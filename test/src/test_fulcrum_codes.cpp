...
namespace
{
    void test_fulcrum_api(kodo_factory_t fulcrum_factory)
    {
        ...
        kodo_coder_t coder = kodo_factory_new_decoder(fulcrum_factory);
        EXPECT_TRUE(coder != 0);
        ...
        kodo_coder_t other_coder = kodo_factory_new_decoder(fulcrum_factory);
